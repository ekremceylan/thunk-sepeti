...
const RestaurantCard = ({data}) => {
  ...
  return (
    <Link to={`/restaurant/${data.id}`} className='shadow rounded-lg overflow-hidden hover:bg-gray-200 transition cursor-pointer hover:shadow-lg'>
        ...
        <div className='p-3'>
            ...
            <div className='flex gap-4 items-center'>
              ...
              {
                data.isDeliveryFree && (<p className='flex gap-2 items-center text-red-500 font-semibold text-sm'><MdDeliveryDining /> Ücretsiz</p>)
